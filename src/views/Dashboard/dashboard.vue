            ...
            <v-card-title>
              <v-row align="start">
                <div class="pr-5">
                  ...
                  <strong v-if="avg">عدد التدريسين</strong>
                </div>
              </v-row>
            ...
            <v-card-title>
              <v-row align="start">
                <div class="pr-5">
                  ...
                  <strong v-if="avg">عدد الطلاب</strong>
                </div>
              </v-row>
            ...
            <v-card-title>
              <v-row align="start">
                <div class="pr-5">
                  ...
                  <strong v-if="avg">عدد المواد</strong>
                </div>
              </v-row>
        ...
        <v-skeleton-loader :loading="loading" :transition="transition" type="card">
          <v-card class="mx-auto" max-width="400">
            ...
            <v-card-text class="pt-0">
              <div class="title font-weight-light mb-2">عدد الغيابات الكلي</div>
      ...
      <v-col cols="12" md="4" sm="12">
        <v-skeleton-loader :loading="loading" :transition="transition" type="card">
          <v-card class="mx-auto" max-width="400">
            ...
            <v-card-text class="pt-0">
              <div class="title font-weight-light mb-2">عدد الانذارات الكلي</div>
      ...
      <v-col cols="12" md="4" sm="12">
        <v-skeleton-loader :loading="loading" :transition="transition" type="card">
          <v-card class="mx-auto" max-width="400">
            ...
            <v-card-text class="pt-0">
              <div class="title font-weight-light mb-2">عدد المفصولين الكلي</div>
...
export default {
  data: () => ({
    ...
    chartData: {
      columns: ["name", "number"],
      rows: [
        { name: "غياب", number: 3590 },
        { name: "حضور", number: 3367 }
      ]
    },
