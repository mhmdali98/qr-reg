<template>
  <div>
    <v-toolbar dense flat color="grey lighten-4">
      <v-toolbar-title class="pl-2">الطلاب</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn color="#55AB88" dark @click="detailsDialog = true">اضافة طالب</v-btn>
    </v-toolbar>
...
export default {
  data() {
    return {
      ...
      headers: [
        { sortable: false },
        { text: "الاسم الطالب", value: "name" },
        { text: "المرحلة", value: "stage" },
        { text: "القسم", value: "dep" },
        { text: "الغيابات", value: "locationLat" },
        { text: "نسبة الغياب ", value: "locationLon" },
