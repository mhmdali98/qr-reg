<template>
  <div>
    <v-toolbar dense flat color="grey lighten-4">
      <v-toolbar-title class="pl-2">الاقسام</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn color="#55AB88" dark @click="detailsDialog = true">اضافة قسم</v-btn>
    </v-toolbar>
...
export default {
  data() {
    return {
      ...
      headers: [
        { sortable: false },
        { text: "اسم القسم ", value: "name" },
        { text: "اسم الكلية", value: "contact" },
        { text: "العمليات", value: "actions" }
      ],
      items: [
        {
          name: "تكنلوجيا معلومات",
          contact: "معلوماتية الاعمال"
        },
        {
          name: "ادارة اعمال",
          contact: "معلوماتية الاعمال"
