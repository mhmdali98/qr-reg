<template>
  <div>
    <v-toolbar dense flat color="grey lighten-4">
      <v-toolbar-title class="pl-2">المواد</v-toolbar-title>
      <v-spacer></v-spacer>
            ...
            <template v-slot:item.actions="{ item }">
              <v-tooltip bottom>
                <template v-slot:activator="{ on }">
                  <router-link to="showDate">
                    <v-btn class="indigo--text" icon v-on="on" large>
                      <v-icon l @click color="red">mdi-calendar-plus</v-icon>
                    </v-btn>
                  </router-link>
                </template>
                <span>معاينة</span>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "المرحلة ", value: "stag" },
        { text: " القسم ", value: "deb" },
        { text: " الكلية ", value: "colg" },
      ...
      items: [
        {
          name: "php",
          stag: "ثالثة",
          deb: "تكنولوجيا معلومات",
          colg: "معلوماتيه الاعمال"
        },
        {
