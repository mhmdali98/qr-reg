<template>
  <div>
    <v-toolbar dense flat color="grey lighten-4">
      <v-toolbar-title class="pl-2">HCI</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn color="#55AB88" dark @click="detailsDialog = true">اضافة محاضرة</v-btn>
    </v-toolbar>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        // { text: "عدد الغيابات", value: "total" },
        // { text: "نسبة الغياب", value: "persent" },
